...
class ACTPolicy(nn.Module):
    ...
    def __call__(self, image, depth_image, audio_data, robot_state, actions=None, action_is_pad=None):
        ...
        if actions is not None:  # training time
            ...
            a_hat, (mu, logvar) = self.model(image, depth_image, audio_data, robot_state, actions, action_is_pad)
