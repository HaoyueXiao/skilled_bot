...
def train(args):
    ...
    train_dataloader, val_dataloader, stats, _ = load_data(dataset_dir, num_episodes, args.arm_delay_time,
                                                           args.use_depth_image, args.use_audio, args.use_robot_base, camera_names,
...
def forward_pass(policy_config, data, policy):
    ...
    if policy_config['use_audio']:
        audio_data = audio_data.cuda()
    else:
        audio_data = None
    return policy(image_data, image_depth_data, audio_data, qpos_data, action_data, action_is_pad)
