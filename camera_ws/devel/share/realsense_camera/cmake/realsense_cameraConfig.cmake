...
if("TRUE" STREQUAL "TRUE")
  set(realsense_camera_SOURCE_PREFIX /home/jianrenw/Documents/skilled/cobot_magic/camera_ws/src/realsense_camera)
  set(realsense_camera_DEVEL_PREFIX /home/jianrenw/Documents/skilled/cobot_magic/camera_ws/devel)
  ...
  set(realsense_camera_INSTALL_PREFIX /home/jianrenw/Documents/skilled/cobot_magic/camera_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jianrenw/Documents/skilled/cobot_magic/camera_ws/src/realsense_camera/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT realsense_camera_NUM_DUMMY_TARGETS)
      set(realsense_camera_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::realsense_camera::wrapped-linker-option${realsense_camera_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR realsense_camera_NUM_DUMMY_TARGETS "${realsense_camera_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::realsense_camera::wrapped-linker-option${realsense_camera_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND realsense_camera_LIBRARIES "${interface_target_name}")
...
set(realsense_camera_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(realsense_camera_EXPORTED_TARGETS ${${realsense_camera_dep}_EXPORTED_TARGETS})
endforeach()
