...
(cl:defmethod cl:initialize-instance :after ((m <AudioData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AudioData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sounddevice_ros-msg:<AudioData> is deprecated: use sounddevice_ros-msg:AudioData instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <AudioData>))
...
(cl:defmethod data-val ((m <AudioData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sounddevice_ros-msg:data-val is deprecated.  Use sounddevice_ros-msg:data instead.")
  (data m))
